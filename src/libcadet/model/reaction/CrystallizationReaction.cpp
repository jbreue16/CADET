...
namespace cadet
{
	...
	namespace model
	{
		...
		namespace detail
		{
			// TO DO: think about moving the diffusion term here
		...
		protected:
				...
				StateType const* y, ResidualType* res, const FactorType& factor, LinearBufferAllocator workSpace) const
			{
				...
				case 4:
				{
					// define local variables for WENO5
					StateParam IS_0 = 0.0;
					StateParam IS_1 = 0.0;
					StateParam IS_2 = 0.0;
					StateParam alpha_0 = 0.0;
			...
			void jacobianLiquidImpl(double t, unsigned int secIdx, const ColumnPosition& colPos, double const* y, double factor, RowIterator& jac, LinearBufferAllocator workSpace) const
			{
				...
				// local variables to aid jacobian implementation
				...
				case 4:
				{
					...
					// WENO5 Jacobian related coefficients
